...
| `exclusions.ts` | Индекс исключений: какая директива и какое `ctl` какое правило снимают или правят и доживают ли до него |
...
проход не обязан ничем — ошибок он не выдаёт вовсе, — поэтому на большом файле идёт по частям
