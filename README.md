...
Начать с чистого листа — тоже замена, а не «удалить всё»: набор без файлов это редактор без текста,
и вернуться в него было бы неоткуда. Поэтому новый набор — один пустой файл, и о невыгруженных
правках он спрашивает теми же словами, что пример и открытие.
