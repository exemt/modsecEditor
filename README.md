...
и ошибка в ней ничем себя не выдаёт. Рядом сказано и то, чего в записи нет: до каких правил файла
она дотянулась и в каком звене цепочки написана. Звено — часть смысла: `ctl` из головы применится,
едва совпала голова, а из последнего звена — когда совпала вся цепочка, поэтому действия звеньев
модель хранит у звеньев и возвращает их туда же.
